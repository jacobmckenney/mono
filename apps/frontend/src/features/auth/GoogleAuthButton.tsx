...
export const GoogleAuthButton: Component<Props> = ({ type, ...rest }) => {
    ...
    return (
        <>
            <Button
                class="flex gap-6 items-center w-full justify-center h-7 min-w-fit"
                {...rest}
...
const Logo = () => (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" style={{ display: "block" }} height={20}>
        <path
            fill="#EA4335"
